    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        exitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(D) Log.d(TAG, "fragments in backStack: "+ fm.getBackStackEntryCount() + " at 0: " + fm.getBackStackEntryAt(0) );

                fm.popBackStack(DetailsFragment.REPLACE_DETAILS_WITH_RESULT, FragmentManager.POP_BACK_STACK_INCLUSIVE);
            }
        });
