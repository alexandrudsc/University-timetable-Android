...
/** Created by alexandru on 10/20/16. Very Raw API of USV server. */
public final class CsvAPI {
  ...
  public static final String PARTIAL_GROUP_TIMETABLE_URL =
      USV_ENDPOINT
          + "vizualizare/data/orarSPG.php?mod=grupa&ID="; // Partial URl for non_modular timetables
  public static final String PARTIAL_PROF_TIMETABLE_URL =
      USV_ENDPOINT
          + "vizualizare/data/orarSPG.php?mod=prof&ID="; // Partial URl for profs timetables

  /** Result format for timetable of group. Result format for timetable of professor. */
