...
public class DownloadActivity extends Activity
    implements DownloadActivityView, View.OnClickListener {
  ...
  private void createWithoutConnection() {
    Button tryAgainBtn = findViewById(R.id.buttonTryAgain);
    tryAgainBtn.setOnClickListener(this);
  }

  private void createWithConnection() {
    webView = findViewById(R.id.webview);
    downloadBtn = findViewById(R.id.timetable_download_btn);
  ...
  public void setDownloadBtnText(String text) {
    Button downloadBtn = findViewById(R.id.timetable_download_btn);
    if (downloadBtn != null) {
