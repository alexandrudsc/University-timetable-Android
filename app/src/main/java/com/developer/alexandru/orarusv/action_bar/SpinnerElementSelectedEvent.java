...
public class SpinnerElementSelectedEvent
    implements Spinner.OnItemSelectedListener { // ActionBar.OnNavigationListener {
  public static final String ACTION_LAUNCH_EVENT_ACTIVITY =
      "com.alexandru.developer.action.LAUNCH_NON_CURRENT_WEEK_ACTIVITY";
  public static final String CATEGORY_NON_CURRENT_WEEK =
      "com.alexandru.developer.category.SECOND_ACTIVITY";
  ...
  public boolean onNavigationItemSelected(int position, long itemId) {
    ...
    SharedPreferences prefs =
        activity.getSharedPreferences(MainActivity.TIME_ORGANISER_FILE_NAME, Context.MODE_PRIVATE);

    if (position
        != prefs.getInt(MainActivity.PREF_LAST_SELECTED_WEEK, MainActivity.WEEKS_IN_SEMESTER - 1)) {
