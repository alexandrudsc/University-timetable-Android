...
/**
 * Created by alexandru on 9/15/16. Event listener for LongClick on a course from list
 * (MainActivity, NonCurrentWeek)
 */
public class OnCourseLongClickListener implements View.OnLongClickListener {
  ...
  public boolean onLongClick(View var1) {
    ...
    AlternativeCoursesListAdapter adapter =
        new AlternativeCoursesListAdapter(
            courseSelectedCallback.getActivity(), R.layout.simple_course_layout, items);
        ...
        .setOnCancelListener(
            new DialogInterface.OnCancelListener() {
              ...
              public void onCancel(DialogInterface dialogInterface) {
                if (courseSelectedCallback != null
                    && courseSelectedCallback.getActivity() != null) {
    ...
    AlternativeCoursesLoader alternativeCoursesLoader =
        new AlternativeCoursesLoader(adapter, this.course);
