...
/**
 * Created by Alexandru on 7/1/14. The adapter for the navigation drawer (helper for backing up the
 * list with data)
 */
public class NavDrawerAdapter extends BaseAdapter {
  ...
  public Object getItem(int position) {
    if (position < 0 && position > NAV_DRAWER_ELEM_COUNT) return null;
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    TextView tv = convertView.findViewById(R.id.nav_elem_tv);
